<template>
  <div class="imageContainer">
      ...
      <a-space>
        ...
        <a-dropdown>
          ...
          <a-menu slot="overlay">
            ...
            <a-menu-item>
                <a href="#"
                   @click="callControlContainerApi(record.containerId,'restart')">重启容器</a>
            </a-menu-item>
            <a-menu-item>
                <a href="#"
                   @click="openRemoveDetail(record.containerId)">删除容器</a>
            </a-menu-item>
            <a-menu-item>
              <a href="#">导出容器</a>
            </a-menu-item>
    ...
    <a-modal v-model="showRemoveVisible" title="删除容器选项"
             ...
             okText="确定"
             cancelText="关闭">
      <a-checkbox @change="removeVolume" :checked="remove.volume">移除 Volume
      </a-checkbox>
      <a-checkbox @change="removeLink" :checked="remove.link">移除 Links
      </a-checkbox>
      <a-checkbox @change="removeForce" :checked="remove.force">强制移除
      </a-checkbox>
